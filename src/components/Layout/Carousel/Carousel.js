...
const CarouselContent = (props)=> (
    <Fragment>
        <Carousel autoplay={'true'} emulateTouch={'true'} showThumbs={'false'} infiniteLoop={'true'} width={"95vh"} showArrows={'true'} dynamicHeight={'true'}>
            ...
            <p className="legend">"Have many goals, but always prioritize them.  Have goals for your goals.  Sometimes the path to your goal has multiple steps.  Route it out and take one step at a time."</p>
            </div>
            <div>
